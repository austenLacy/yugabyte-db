...
func init() {
	...
	flag.StringVar(&MasterHost, "database_host", "127.0.0.1",
		"Advertise address of the YugabyteDB master node.")
	flag.StringVar(&TserverHost, "tserver_host", "127.0.0.1",
		"Advertise address of the YugabyteDB tserver.")
